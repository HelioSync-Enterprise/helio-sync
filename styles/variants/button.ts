...
export const buttonVariants = tv({
	base: 'inline-flex items-center justify-center gap-2 rounded-full font-semibold tracking-[0.01em] transition-all duration-200 ease-out disabled:cursor-not-allowed disabled:opacity-60 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--helio-focus)]',
	variants: {
		variant: {
			...
			enter: 'h-11 min-w-28 px-6 text-xl bg-helio-gradient-gold text-helio-bg-tertiary shadow-[2px_2px_18px_-6px_rgb(255_215_0_/_0.95)] hover:brightness-110 cursor-pointer',
