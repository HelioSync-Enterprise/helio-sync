...
export function HeroSection() {
	return (
		<section className="mx-auto flex min-h-screen w-full flex-col items-center justify-center gap-10 overflow-hidden px-5 py-24 sm:px-6 md:px-10 lg:flex-row lg:items-center lg:justify-between lg:gap-12 lg:px-12 lg:py-14 min-[1920px]:max-w-[78%] min-[1920px]:gap-20">
