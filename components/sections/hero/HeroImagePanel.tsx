...
export function HeroImagePanel() {
	return (
		<div className="relative z-10 hidden flex-1 lg:block">
			...
			<div className="absolute bottom-4 left-1/2 flex h-[25%] w-[94%] -translate-x-1/2 items-center rounded-2xl border border-foreground/15 bg-foreground/10 p-4 text-sm backdrop-blur-sm">
